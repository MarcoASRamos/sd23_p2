...
sshpass -f password ssh sd202@l040101-ws09.ua.pt 'cd test/MuseumHeist ; unzip -uq dirOrdinary.zip'
sshpass -f password scp genclass.zip sd202@l040101-ws09.ua.pt:test/MuseumHeist/dirOrdinary
sshpass -f password ssh sd202@l040101-ws09.ua.pt 'cd test/MuseumHeist/dirOrdinary ; unzip -uq genclass.zip'
echo "Executing program at the Ordinary node."
sshpass -f password ssh sd202@l040101-ws09.ua.pt 'cd test/MuseumHeist/dirOrdinary ; java clientSide.main.ClientOrdinary l040101-ws06.ua.pt 22426 l040101-ws05.ua.pt 22425 l040101-ws03.ua.pt 22423 l040101-ws02.ua.pt 22422 l040101-ws01.ua.pt 22421 l040101-ws07.ua.pt 22427'